...
let gameState='title';
let player=mkPlayer();
function mkPlayer(){return{x:0,z:0,yaw:0,pitch:0,hp:100,maxHp:100,mp:50,maxMp:50,level:1,xp:0,xpNext:100,gold:0,kills:0,attackPower:22,defense:5,speed:.055,skills:[{name:'火球',cd:0,maxCd:3,cost:15},{name:'雷撃',cd:0,maxCd:5,cost:25},{name:'回復',cd:0,maxCd:8,cost:20}]};}
